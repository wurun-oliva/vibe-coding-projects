...
const QA = [
  ...
  {
    keys: ['兴趣', '爱好', '喜欢'],
    a: '吴润喜欢绘画、陶艺、健身和阅读。技术之外,他也在用艺术和运动平衡自己。'
  },
  {
    keys: ['在做', '最近', '现在', '忙什么'],
  ...
  {
    keys: ['项目', '作品', '做过'],
    a: '吴润的项目有:个人主页(就是这个,含数字分身)、心理记录、健身记录。后两个还在完善中。'
  },
  {
    keys: ['心理', '心情'],
    a: '心理记录是吴润在做的项目之一,具体内容还在补充。'
  },
  {
    keys: ['健身', '运动'],
    a: '健身是吴润的兴趣之一,他也在做一个健身记录项目,具体内容待补充。'
  },
  {
    keys: ['你好', 'hi', 'hello', '嗨'],
    a: '你好!我是吴润的数字分身,可以问我他的专业、兴趣、最近在做什么。'
  }
];
...
function answer(q) {
  ...
  return '这个问题我暂时答不上来,换个问法试试?比如问我吴润的专业、兴趣或最近在做什么。';
}
